...
func _1511810746_create_resource_spacesDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1511810746_create_resource_spaces.down.sql", size: 562, mode: os.FileMode(420), modTime: time.Unix(1512398283, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func _1511810746_create_resource_spacesUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1511810746_create_resource_spaces.up.sql", size: 907, mode: os.FileMode(420), modTime: time.Unix(1512398283, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
